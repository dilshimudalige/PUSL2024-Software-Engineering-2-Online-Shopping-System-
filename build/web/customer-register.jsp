                    ...
                    <div class="login-grids">
                        <div class="login">
                            <div class="login-bottom">
                                <h3 style="color: #145A32;">Sign up for free</h3>
                                <%
                                ...
                                <form action="AddCustomer" method="post">
                                    ...
                                    <div class="sign-up">
                                        <input type="submit" value="REGISTER NOW" style="width: 680px; color: #145A32">
                                    </div>
                                </form>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <p>
                            <a href="customer-login.jsp" style="color: #145A32;">Existing Customer? Log In</a>
                        </p>
                    </div>
                </div>
            </div>
