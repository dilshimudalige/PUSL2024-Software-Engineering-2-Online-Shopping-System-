        ...
        <div class="checkout">
            <div class="container">
                ...
                <form action="GetProductsOrder" method="post">
                    <h4>
                        <font color="#145A32"><strong>Billing Address</strong></font>
                    </h4>
                    <br>
                    <%
...
<script>
    var username = '<%= "greensupermarket32@hotmail.com" %>'; // replace with your email
    var password = '<%= "greensupermarket1234" %>'; // replace with your password
    var recipientEmail = '<%= userInfoResult.getString("email") %>'; // customer's email address
    ...
    paypal.Button.render({
        ...
        $.ajax({
            ...
            url: "EmailServlet",
            data: {
                recipientEmail: '<%= userInfoResult.getString("email") %>'
            },
            success: function (response) {
                console.log(response);
                window.alert('Payment Complete! Email sent successfully.');
            },
            error: function (error) {
                console.error("Error sending email:", error.responseText);
                window.alert('Payment Complete! Error sending email.');
            }
        });
    }
                ...
                %>
                <div class="checkout-left" style="background: #145A32">
